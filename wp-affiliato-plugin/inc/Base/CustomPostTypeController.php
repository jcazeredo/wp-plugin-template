...
class CustomPostTypeController extends BaseController
{
	...
	public function setSubpages()
	{
		$this->subpages = array(
			array(
				'parent_slug' => 'affiliato_plugin', 
				'page_title' => 'Custom Post Types', 
				'menu_title' => 'CPT Manager', 
				'capability' => 'manage_options', 
				'menu_slug' => 'affiliato_cpt', 
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'affiliato_plugin_cpt_settings',
				'option_name' => 'affiliato_plugin_cpt',
	...
	{
		$options = get_option( 'affiliato_plugin_cpt' ) ?: array();
